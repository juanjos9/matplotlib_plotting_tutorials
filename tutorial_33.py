...
# Number of points in total domain along r/theta axis
n = 101
...
# Slicer index for smoother quiver plots
...
# Additional tweaks
plt.grid(True)
plt.quiverkey(Quiver, 1.01, 1.01, 3, label = '3 m/s', labelcolor = 'blue', labelpos = 'N', coordinates = 'axes')
# plt.colorbar(Quiver)
